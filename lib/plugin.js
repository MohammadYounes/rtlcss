  ...
  return {
    ...
    'control': {
      'ignore': {
        ...
        'end': function (node, context) {
          ...
          if (node.type === 'comment' || node.type === 'decl' && context.util.isLastDecl(node)) {
            context.skip = {}
            return true
          }
          return false
    ...
    'property': [
      ...
      },
      {
        ...
        'action': function (prop, value, context) {
          var tokens = context.util.saveFunctions(this.saveOthers(value))
          tokens.value = tokens.value.replace(/[^,]+/g, function (m) {
            return context.util.negate(m)
          })
          return { 'prop': prop, 'value': this.restoreOthers(context.util.restoreFunctions(tokens)) }
        }
      },
      {
      ...
      },
      {
        ...
        'flip': function (value, process, context) {
          var replace = context.util.regex(['calc', 'number'], 'ig')
          var i = 0
