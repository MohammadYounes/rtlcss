  ...
  'control': {
    ...
    'options': {
      ...
      'begin': function (node, metadata, context) {
        ...
        var options = JSON.parse(metadata.param)
  ...
  'property': [
    ...
    },
    {
      ...
      'update': function (context, value, name) {
        ...
        } else if (context.config.processUrls === true && name.match(this.cache.url)) {
    ...
    },
    {
      ...
      'cache': null,
      'update': function (context, value, name) {
        if (context.config.processUrls === true && name.match(this.cache.url)) {
          value = context.util.applyStringMap(value, true)
        }
        return value
      },
